...
class DrawingPanel extends JPanel {
    /* A JPanel is a lightweight component.
       ...
       Override the paintComponent function to draw on it.
       Let's see how.
    */
...
public class FunWithUserInterfaces {
	public static void main(String[] args) {
		FancyCustomFrame frm1 = new FancyCustomFrame();
		frm1.setVisible(true);
		FancyCustomFrame frm2 = new FancyCustomFrame("Even fancier", 300, 100, 600, 200, JFrame.HIDE_ON_CLOSE);
