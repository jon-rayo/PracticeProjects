		...
		btnChange.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					panCenter.setFontSize(fontSize);
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(null, "The font size must be an integer.")
;				}
				repaint(); // repaints the entire window's contents
							// panCenter will be repainted ---> paintCompintnet for TextPanel
	...
	public void setUpMenu() {
		...
		miAbout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Copyright 2020 Rayo");
			}
		});
		mnuHelp.add(miAbout);
		mbar.add(mnuFile);
